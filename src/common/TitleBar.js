                    ...
                    <View style={styles.titleBarButtonContainer}>
                        ...
                        <View style={{
                            ...
                            <MenuPopWindow
                                ...
                                menuIcons={[require('../img/ic_pop_group_chat.png'), require('../img/ic_pop_add_friends.png'), require('../img/ic_pop_scan.png'),
                                    require('../img/ic_pop_help.png')]}
                                menuTexts={['发起群聊', '添加朋友', '扫一扫', '帮助与反馈']}
                            />
                        </View>
                    </View>
                </View>
