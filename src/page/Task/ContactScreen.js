        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={styles.container}>
                    <TouchableOpacity style={styles.welcome} onPress={this.openContactPicker}>
                        <Text>打开通讯录选择器</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.welcome} onPress={this.getAllContact}>
                        <Text>获取全部通讯录</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.welcome} onPress={this.checkContactPermissions}>
                        <Text>是否有通讯录权限</Text></TouchableOpacity>
                </View>
            </View>
        );
    }
